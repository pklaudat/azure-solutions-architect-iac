...
resource app 'Microsoft.Web/sites@2024-04-01' = [
  for i in range(0, length(listOfAppNames)): {
...
resource disableScm 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2024-04-01' = [
  for i in range(0, length(listOfAppNames)): {
...
resource injectVnet 'Microsoft.Web/sites/networkConfig@2024-04-01' = [
  for i in range(0, length(listOfAppNames)): {
    name: 'virtualNetwork'
    parent: app[i]
    properties: {
...
resource privateEndpointDnsIntegration 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-05-01' = [
  for i in range(0, length(listOfAppNames)): {
    name: 'default'
